...
@cross_origin()
def processFrame():
    print ("In Frame [ProcessVideo.py]")
    ...
    #print "Getting Emos [ProcessVideo.py]"
    res = get_emotion(nets, data, companyId, campaignId, participantId, timestamp, ageGenderCache)  #Driver.py
